@testset "Vertical interpolation" begin
    ...
    E_pre = interpolation2pressure(E, pressure, pressure_levels; vertical_dim=my_dim, extrapolation_bc=NaN )
    E_pre2 = interpolation2pressure(reverse(E,dims=my_dim), reverse(pressure,dims=my_dim), pressure_levels; vertical_dim=my_dim, extrapolation_bc=NaN, descending = false )
